...
std::string jenisUjiToString(int kode)
{
    ...
    {
    case 1:
        return "Uji Tarik (Tensile Test)";
    case 2:
        return "Uji Tekan (Compression Test)";
    case 3:
        return "Uji Kekerasan (Hardness Test)";
    case 4:
        return "Uji Impak (Impact Test)";
    case 5:
        return "Uji Lentur (Flexural Test)";
    case 6:
        return "Uji Kelelahan (Fatigue Test)";
    case 7:
        return "Uji Korosi (Corrosion Test)";
    case 8:
        return "Metalografi (Metallography)";
    case 9:
        return "Analisis Komposisi (SEM/EDX)";
    case 10:
        return "Analisis Termal (TGA/DSC)";
    default:
...
public:
    ...
    std::vector<SampleData> getAll()
    {
        ...
        while (curr != nullptr)
        {
            result.push_back({curr->noAntrean,
                              curr->kode,
                              curr->pengirim,
                              curr->jenisUjiKode,
